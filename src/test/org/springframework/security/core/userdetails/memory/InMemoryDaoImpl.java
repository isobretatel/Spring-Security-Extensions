...
public class InMemoryDaoImpl implements UserDetailsService, InitializingBean {
    ...
    /**
     * Modifies the internal <code>UserMap</code> to reflect the <code>Properties</code> instance
     * passed. This helps externalise user information to another file etc.
     *
     * @param props the account information in a <code>Properties</code> object format
     */
    public void setUserProperties(final Properties props) {
